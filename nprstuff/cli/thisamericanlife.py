...
def _main( ):
    ...
    parser.add_argument( '-e', '--episode', dest='episode', type=int, action='store', default = 150,
                        help = 'Episode number of This American Life to download. Default is 150.' )
    parser.add_argument( '-d', '--directory', dest='directory', type=str, action='store',
                        default = _default_inputdir,
                        help = 'Directory into which to download This American Life episodes. Default is %s.' %
                        _default_inputdir )
    parser.add_argument( '-E', '--extra', dest='extraStuff', type=str, action='store',
